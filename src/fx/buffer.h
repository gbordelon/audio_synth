...
void fx_unit_buffer_read_chunk(fx_unit_idx idx, FTYPE buf[2 * CHUNK_SIZE]);
void fx_unit_buffer_write_chunk(fx_unit_idx idx, FTYPE buf[2 * CHUNK_SIZE], size_t write_idx);
